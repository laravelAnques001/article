            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h4>
                        ...
                        <span class="text-semibold">Polls Edit</span>
                    </h4>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-horizontal">
                        <div class="panel panel-flat">
                            ...
                            <form action="{{ route('polls.update', base64_encode($polls->id)) }}" method="POST"
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="title" id="title"
                                                placeholder="Enter Polls title"
                                                value="{{ old('title', $polls->title) }}">
                                            @error('title')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="link" id="link"
                                                placeholder="Enter Polls Link" value="{{ old('link', $polls->link) }}">
                                            @error('link')
                                                <span class="error">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label" for="image">Polls
                                            image:</label>
                                        <div class="col-lg-9">
                                            ...
                                            @error('image')
                                                <span class="error">{{ $message }}</span>
                                            @enderror
                                            <img src="{{ $polls->image_url }}" alt="Polls Image" width="100"
                                                height="100">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea rows="2" cols="5" class="form-control" name="description" id="description"
                                                placeholder="Enter Polls Description">{{ old('description', $polls->description) }}</textarea>
                                            @error('description')
                                                <span class="error">{{ $message }}</span>
                                            @enderror
                                        </div>
