                        ...
                        function(isConfirm) {
                            if (isConfirm) {
                                $.ajax({
                                    ...
                                    swal({
                                        title: "Deleted!",
                                        text: "Polls has been successfully deleted..",
                                        type: "success",
                                        showCancelButton: true,
                                        closeOnConfirm: false,
        ...
        <div class="page-header">
            <div class="page-header-content">
                <div class="page-title">
                    <h4><span class="text-semibold">Polls list</span></h4>
                </div>
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a href="{{ route('polls.create') }}"
                            class="btn btn-labeled btn-labeled-right bg-blue heading-btn">Create Polls
                        </a>
                    </div>
                </div>
            </div>
