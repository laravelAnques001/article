            ...
            <div class="col-md-12">
                ...
                <div class="form-horizontal">
                    <div class="panel panel-flat">
                        ...
                        <form action="{{ route('users.update', base64_encode($user->id)) }}" method="POST" enctype="multipart/form-data" id="userForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-1">
                                    <input type="text" class="form-control" name="dial_code" id="dial_code"
                                        placeholder="91" value="{{ old('dial_code',$user->dial_code) }}">
                                    @error('dial_code')
                                        <span class="error">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="mobile_number" id="mobile_number"
                                        placeholder="Enter User Mobile Number" value="{{ old('mobile_number',$user->mobile_number) }}">
                                    @error('mobile_number')
                                        <span class="error">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="device_token" id="device_token"
                                        value="{{ old('device_token',$user->device_token) }}" placeholder="Enter User Device Token">
                                    @error('device_token')
                                        <span class="error">{{ $message }}</span>
                                    @enderror
                                </div>
