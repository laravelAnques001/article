        ...
        <div class="page-header-content">
            <div class="page-title">
                <h4>
                    ...
                    <span class="text-semibold">Services Edit</span>
                </h4>
            </div>
                ...
                <div class="form-horizontal">
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            <form action="{{ route('services.update', base64_encode($services->id)) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="title" id="title"
                                            placeholder="Enter Title" value="{{ old('title', $services->title) }}">
                                        @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="company_name" id="company_name"
                                            ...
                                            value="{{ old('company_name', $services->company_name) }}">
                                        @error('company_name')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" name="location" id="location"
                                            placeholder="Enter location" value="{{ old('location', $services->location) }}">
                                        @error('location')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea class="ckeditor form-control" name="description" id="description" placeholder="Enter Description">{{ old('description', $services->description) }}</textarea>
                                        @error('description')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
