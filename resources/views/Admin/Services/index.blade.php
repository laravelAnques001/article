    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('.customer-table').DataTable({
                ...
                "select": true,
                "ajax": {
                    "url": "{{ route('admin.services.getData') }}",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
                        _token: "{{ csrf_token() }}"
        ...
        <div class="page-header">
            <div class="page-header-content">
                <div class="page-title">
                    <h4><span class="text-semibold">Services list</span></h4>
                </div>
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a href="{{ route('services.create') }}" class="btn btn-labeled-right bg-blue heading-btn">Create
                            Services
                        </a>
                    </div>
                </div>
