...
@section('content')
    ...
    <p>When using our service, I may ask you for certain personally identifying information, such as but not limited to
        department:In order to offer you with a better experience. The data I seek from you will be stored on your device; I
        do not in any way gather it.</p>
    ...
    <p>Communicate with you, either directly or through one of our partners, including for customer service, to provide you
        with updates and other information relating to the website, and for marketing and promotional purposes</p>
    ...
    <p>I want to let you know that whenever you use my Service, I may gather data and information (via third-party products)
        on your phone called Log Data in the event that the app has a problem. Your device&#39;s Internet Protocol
        (&quot;IP&quot;) address, name, operating system version, the app&#39;s configuration when using my service, the
        time and date of your use of the service, and other statistics could all be included in this log data.</p>
    ...
    <p>Cookies are little data files that are frequently employed as anonymous, unique identifiers. These are downloaded
        into the internal memory of your device by your browser from the websites you visit.</p>
    ...
    <p>This App follows a standard procedure of using log files. These files log visitors when they visit websites. All
    ...
    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on App, which are sent directly to users&#39; browser. They
        automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of
        their advertising campaigns and/or to personalise the advertising content that you see on websites that you visit.
    </p>
    ...
    <p>This App Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the
    ...
    <p>These Services do not address anyone under the age of 13. I do not knowingly collect personally identifiable
        information from children under 13. In the case I discover that a child under 13 has provided</p>
