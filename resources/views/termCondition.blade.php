...
@section('content')
    <div class="container">
        ...
        <p>When using our service, I may ask you for certain personally identifying information, such as but not limited to
            department:In order to offer you with a better experience. The data I seek from you will be stored on your
            device; I
        ...
        <p>Communicate with you, either directly or through one of our partners, including for customer service, to provide
            you
        ...
        <p>I want to let you know that whenever you use my Service, I may gather data and information (via third-party
            products)
        ...
        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
            their respective advertisements and links that appear on App, which are sent directly to users&#39; browser.
            They
            automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness
            of
            their advertising campaigns and/or to personalise the advertising content that you see on websites that you
            visit.
        </p>
